...
<p>
  ...
  <a href="https://hatim-merchant.github.io//bloghatim-merchant.github.io/ai/medical%20ai/computer%20vision/blog-post-1/" target="_blank">
    https://hatim-merchant.github.io/bloghatim-merchant.github.io/
  </a>
</p>
...
## Existing Methods
Several approaches have been proposed to address the problem of domain shift in medical imaging. These methods can be broadly categorized into data-level approaches, such as data augmentation and data standardization, as well as feature- and model-level approaches <a href="#ref4">[4]</a>.

Data augmentation improves model generalization by generating additional training samples that introduce controlled variations while preserving the underlying diagnostic information. By exposing the model to a wider range of data during training, it can become more robust when applied to unseen domains <a href="#ref5">[5]</a>. However, this approach increases the amount of data processed during training and may require additional computational resources.

In contrast, data standardization is applied as a preprocessing step before model training. Its objective is to reduce non-semantic variations by aligning the appearance or data distributions across different datasets. For example, in histopathological imaging, stain normalization is commonly used to reduce differences in staining protocols, stain concentrations, and scanner characteristics between laboratories <a href="#ref6">[6]</a>. Although such approaches can improve consistency across datasets, conventional stain normalization methods often rely on explicit color-space transformations, stain separation, or reference-image-based normalization <a href="#ref6">[6]</a>, <a href="#ref7">[7]</a>. More advanced approaches may employ dedicated deep learning models, which can introduce additional computational complexity <a href="#ref7">[7]</a>.
...
![Figure 4: Flow chart of scanner image to a non-semantic standardised feature map]({{ site.baseurl }}/images/Fig4.png)
...
To evaluate the effectiveness of PhyCV, the authors compare it against several established domain generalization approaches. These methods provide different strategies for improving out-of-distribution (OOD) performance under domain shift.

* ERM (Empirical Risk Minimization): The standard baseline in which the model is trained directly on the available source-domain training data without any explicit domain generalization strategy <a href="#ref12">[12]</a>.
* PAIR: Out-of-Domain Robustness via Targeted Augmentations introduces targeted data augmentation designed to improve robustness to specific distribution shifts <a href="#ref8">[8]</a>.
* Fish: A gradient-based domain generalization method that uses gradient matching to encourage models trained on different domains to learn more transferable representations <a href="#ref10">[10]</a>.
* LISA: A selective augmentation approach that improves OOD robustness by augmenting training data in a targeted manner <a href="#ref11">[11]</a>.
* ERM + Target Augmentation: An extension of the standard ERM training procedure that incorporates targeted augmentations to improve robustness to the target-domain distribution <a href="#ref8">[8]</a>.
* ContriMix: An unsupervised domain generalization method designed for microscopy images. It disentangles content and domain-specific attributes and uses this separation to generate more domain-robust training examples <a href="#ref9">[9]</a>.
* PST (ours): The proposed PhyCV-based approach, which applies the Phase Stretch Transform as a deterministic preprocessing step before the images are provided to the neural network. Unlike the other approaches, PST addresses domain shift primarily at the input representation level, without modifying the model architecture or introducing an additional domain-generalization training objective <a href="#ref1">[1]</a>.
...
<p id="ref1">
[1] C. MacPhee, Y. Zhou, K. Kishima, and B. Jalali,
"Standardizing Medical Images at Scale for AI,"
arXiv preprint arXiv:2603.15980, 2026.
</p>
...
<p id="ref3">
[3] Y. Zhou, C. MacPhee, M. Suthar, and B. Jalali,
"PhyCV: The First Physics-inspired Computer Vision Library,"
arXiv preprint arXiv:2301.12531, 2023.
</p>

<p id="ref4">
[4] J. S. Yoon, K. Oh, Y. Shin, M. A. Mazurowski, and H.-I. Suk,
"Domain Generalization for Medical Image Analysis: A Review,"
Proceedings of the IEEE, 2024.
</p>

<p id="ref5">
[5] C. Ouyang, C. Chen, S. Li, Z. Li, C. Qin, W. Bai, and D. Rueckert,
...
IEEE Transactions on Medical Imaging, vol. 35, no. 8, pp. 1962–1971, 2016.
</p>
...
<p id="ref8">
[8] I. Gao, S. Sagawa, P. W. Koh, T. Hashimoto, and P. Liang,
...
<p id="ref12">
[12] I. Gulrajani and D. Lopez-Paz,
