...
![Figure 1: Domain Shift Problem]({{ site.baseurl }}/images/Fig1.png)
*Figure 1: Overview of the data input from various sources introducing domain shift because of variations in acquisition protocols.*
...
![Figure 2: Multi-Hospital Data Standardization]({{ site.baseurl }}/images/Fig2.png)
*Figure 2: Data from five different hospitals are processed through the PhyCV framework to achieve refined and standardized histopathology images, reducing inter-institutional variability.*
...
![Figure 3: Training Phase]({{ site.baseurl }}/images/5.png)
*Figure 3. Workflow of the proposed framework, illustrating multi-hospital data standardization using PhyCV followed by deep neural network training via backpropagation.*
...
![Figure 4: OOD Data Partitioning]({{ site.baseurl }}/images/4.png)
*Figure 4. Cross-hospital data partitioning for out-of-distribution (OOD) evaluation, where data from Hospitals 1–3 are used for training, Hospital 4 for validation, and Hospital 5 for testing.*
...
![Figure 5: Increasing illumination level changes]({{ site.baseurl }}/images/Fig5.png)
*Figure 5. Effect of progressive information loss on a medical image. Image 1 represents the original image (0% information loss), while Images 2–6 illustrate increasing levels of information loss (20%, 40%, 60%, 80%, and 100%, respectively). As the degree of information loss increases, image intensity and structural details are progressively degraded, demonstrating the impact of information degradation on visual quality and the preservation of diagnostically relevant features.*
